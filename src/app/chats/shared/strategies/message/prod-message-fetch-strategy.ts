...
export class ProdMessageFetchStrategy extends MessageFetchStrategy {
	...
	public override fetchForManyDetails(chatroomId: ID): Observable<MessageDetails[]> {
		return of(MOCK_MESSAGES_DETAILS.filter(m => m.roomId === chatroomId));
	}
